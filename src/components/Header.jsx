    ...
    <header className=" w-full relative md:h-[622px] bg-primaryColor">
      ...
      <div className="flex py-28 md:pt-40  md:flex-row justify-between w-full gap-11 px-4 md:px-72">
        <div className=" ">
          ...
          <button className="md:mt-16 hover:bg-[#f6d964] mt-6 drop-shadow shadow-pryColor font-Karla font-bold md:text-[18px] bg-pryColor rounded-[16px] md:py-4 md:px-9 px-4 py-2">
            Reserve a Table
          </button>
        </div>
        <div>
